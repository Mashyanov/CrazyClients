...
//        wipeButton.setEnabled(true);
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        new ClientWindow(this).setVisible(true);
        fillTheList();   
    }//GEN-LAST:event_addButtonActionPerformed

    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        if(clientList.getSelectedIndex()!=-1){
            new ClientWindow(this, msqlc.getClient(crazyClients.get(clientList.getSelectedIndex()).getId())).setVisible(true);
            fillTheList();
        }
    ...
    private void windowClosing(){
        msqlc.createBackup();
        MyFTPClient client = MyFTPClient.getInstance();
        client.connect();
        dispose();
        client.uploadDBBackUp();
        client.disconnect();
        System.exit(0);
    }
